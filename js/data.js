...
var TROPHIES = {
  ...
  j1: { name: "J1 League", img: "img/trophies/j1.png?v=npfl-concacaf-2", kind: "league", w: 4 },
  uruprimera: { name: "Primera División", img: "img/trophies/uruprimera.png?v=npfl-concacaf-2", kind: "league", w: 4 },
  colbetplay: { name: "Liga BetPlay", img: "img/trophies/colbetplay.png", kind: "league", w: 4 },
  npfl: { name: "NPFL", img: "img/trophies/npfl.png?v=npfl-concacaf-2", kind: "league", w: 3 },
  senliga: { name: "Ligue 1 Sénégal", img: "img/trophies/senliga.png?v=npfl-concacaf-2", kind: "league", w: 3 },
  ...
  ligue2: { name: "Ligue 2", img: "img/trophies/ligue2.png?v=npfl-concacaf-2", kind: "league", w: 3 },
  segunda: { name: "Segunda División", img: "img/trophies/segunda.png?v=npfl-concacaf-2", kind: "league", w: 3 },
  serie_b_ita: { name: "Serie B", img: "img/trophies/serie_b_ita.png?v=npfl-concacaf-2", kind: "league", w: 3 },
  /* Copas nacionais */
  copa: { name: "Copa nacional", img: "img/trophies/copa.png", kind: "cup", w: 4 },
  copa_ng: { name: "Copa da Nigéria", img: "img/trophies/copa_ng.png?v=npfl-concacaf-2", kind: "cup", w: 3 },
  copa_sn: { name: "Coupe du Sénégal", img: "img/trophies/copa_sn.png?v=npfl-concacaf-2", kind: "cup", w: 3 },
  ...
  knvb: { name: "KNVB Beker", img: "img/trophies/knvb.png?v=npfl-concacaf-2", kind: "cup", w: 4 },
  scottish_cup: { name: "Scottish Cup", img: "img/trophies/scottish_cup.png?v=npfl-concacaf-2", kind: "cup", w: 4 },
  copa_be: { name: "Copa da Bélgica", img: "img/trophies/copa_be.png?v=npfl-concacaf-2", kind: "cup", w: 4 },
  copa_tr: { name: "Copa da Turquia", img: "img/trophies/copa_tr.png?v=npfl-concacaf-2", kind: "cup", w: 4 },
  copa_col: { name: "Copa Colômbia", img: "img/trophies/copa_col.png?v=npfl-concacaf-2", kind: "cup", w: 4 },
  us_open: { name: "US Open Cup", img: "img/trophies/us_open.png?v=npfl-concacaf-2", kind: "cup", w: 4 },
  ...
  acl: { name: "Liga dos Campeões da AFC", img: "img/trophies/acl.png?v=npfl-concacaf-2", kind: "continental", w: 8 },
  caf: { name: "Liga dos Campeões da CAF", img: "img/trophies/caf.png?v=npfl-concacaf-2", kind: "continental", w: 8 },
  concacaf: { name: "Concacaf Champions Cup", img: "img/trophies/concacaf.png?v=npfl-concacaf-2", kind: "continental", w: 8 },
  clubworldcup: { name: "Mundial de Clubes", img: "img/trophies/clubworldcup.png?v=npfl-concacaf-2", kind: "continental", w: 8 },
  ...
  luva: { name: "Luva de Ouro", img: "img/trophies/luva.png?v=npfl-concacaf-2", kind: "indiv", w: 5 },
  mvp: { name: "Melhor do campeonato", img: "img/trophies/mvp.png?v=npfl-concacaf-2", kind: "indiv", w: 4 }
};
