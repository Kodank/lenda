...
var TROPHIES = {
  ...
  j1: { name: "J1 League", img: "img/trophies/j1.png?v=assets-fix-2", kind: "league", w: 4 },
  uruprimera: { name: "Primera División", img: "img/trophies/uruprimera.png?v=assets-fix-2", kind: "league", w: 4 },
  colbetplay: { name: "Liga BetPlay", img: "img/trophies/colbetplay.png", kind: "league", w: 4 },
  npfl: { name: "NPFL", img: "img/trophies/npfl.png?v=assets-fix-2", kind: "league", w: 3 },
  senliga: { name: "Ligue 1 Sénégal", img: "img/trophies/senliga.png?v=assets-fix-2", kind: "league", w: 3 },
  ...
  serie_c: { name: "Série C", img: "img/trophies/serie_c.png?v=assets-fix-2", kind: "league", w: 2 },
  championship: { name: "Championship", img: "img/trophies/championship.png?v=assets-fix-2", kind: "league", w: 3 },
  bundesliga2: { name: "2. Bundesliga", img: "img/trophies/bundesliga2.png?v=assets-fix-2", kind: "league", w: 3 },
  ligue2: { name: "Ligue 2", img: "img/trophies/ligue2.png?v=assets-fix-2", kind: "league", w: 3 },
  segunda: { name: "Segunda División", img: "img/trophies/segunda.png?v=assets-fix-2", kind: "league", w: 3 },
  serie_b_ita: { name: "Serie B", img: "img/trophies/serie_b_ita.png?v=assets-fix-2", kind: "league", w: 3 },
  /* Copas nacionais */
  copa: { name: "Copa nacional", img: "img/trophies/copa.png", kind: "cup", w: 4 },
  copa_ng: { name: "Copa da Nigéria", img: "img/trophies/copa_ng.png?v=assets-fix-2", kind: "cup", w: 3 },
  copa_sn: { name: "Coupe du Sénégal", img: "img/trophies/copa_sn.png?v=assets-fix-2", kind: "cup", w: 3 },
  ...
  knvb: { name: "KNVB Beker", img: "img/trophies/knvb.png?v=assets-fix-2", kind: "cup", w: 4 },
  scottish_cup: { name: "Scottish Cup", img: "img/trophies/scottish_cup.png?v=assets-fix-2", kind: "cup", w: 4 },
  copa_be: { name: "Copa da Bélgica", img: "img/trophies/copa_be.png?v=assets-fix-2", kind: "cup", w: 4 },
  copa_tr: { name: "Copa da Turquia", img: "img/trophies/copa_tr.png?v=assets-fix-2", kind: "cup", w: 4 },
  copa_col: { name: "Copa Colômbia", img: "img/trophies/copa_col.png?v=assets-fix-2", kind: "cup", w: 4 },
  us_open: { name: "US Open Cup", img: "img/trophies/us_open.png?v=assets-fix-2", kind: "cup", w: 4 },
  emperor: { name: "Copa do Imperador", img: "img/trophies/emperor.png?v=assets-fix-2", kind: "cup", w: 4 },
  copa_uy: { name: "Copa AUF Uruguai", img: "img/trophies/copa_uy.png?v=assets-fix-2", kind: "cup", w: 4 },
  copa_mx: { name: "Copa MX", img: "img/trophies/copa_mx.png?v=assets-fix-2", kind: "cup", w: 4 },
  ...
  acl: { name: "Liga dos Campeões da AFC", img: "img/trophies/acl.png?v=assets-fix-2", kind: "continental", w: 8 },
  caf: { name: "Liga dos Campeões da CAF", img: "img/trophies/caf.png?v=assets-fix-2", kind: "continental", w: 8 },
  concacaf: { name: "Concacaf Champions Cup", img: "img/trophies/concacaf.png?v=assets-fix-2", kind: "continental", w: 8 },
  clubworldcup: { name: "Mundial de Clubes", img: "img/trophies/clubworldcup.png?v=assets-fix-2", kind: "continental", w: 8 },
  worldcup: { name: "Copa do Mundo", img: "img/trophies/worldcup.png", kind: "nt", w: 16 },
  copaamerica: { name: "Copa América", img: "img/trophies/copaamerica.png?v=assets-fix-2", kind: "nt", w: 9 },
  euro: { name: "Eurocopa", img: "img/trophies/euro.png?v=assets-fix-2", kind: "nt", w: 9 },
  youth: { name: "Título Sub-20", img: "img/trophies/youth.png?v=assets-fix-2", kind: "nt", w: 2 },
  balon: { name: "Bola de Ouro", img: "img/trophies/balon.png?v=assets-fix-2", kind: "indiv", w: 14 },
  bota: { name: "Chuteira de Ouro", img: "img/trophies/bota.png?v=assets-fix-2", kind: "indiv", w: 5 },
  luva: { name: "Luva de Ouro", img: "img/trophies/luva.png?v=assets-fix-2", kind: "indiv", w: 5 },
  mvp: { name: "Melhor do campeonato", img: "img/trophies/mvp.png?v=assets-fix-2", kind: "indiv", w: 4 }
};
...
var EVENTS = [
  ...
  { id: "loan", title: "Empréstimo para jogar", text: "O técnico admite: na base você não estreia. Um clube menor pede empréstimo — comum no começo. Pode virar sequência (2–3) até o Retorno ou um definitivo.", when: { maxAge: 22, roles: ["youth", "bench", "rotation"] }, a: { label: "Aceitar o empréstimo", hint: "Empréstimo · jogos agora", fx: { loan: 1, resilience: 4 } }, b: { label: "Ficar e brigar", hint: "Menos minutos, mais visibilidade", fx: { loyalty: 5, coach: -6, energy: -6 } } },
